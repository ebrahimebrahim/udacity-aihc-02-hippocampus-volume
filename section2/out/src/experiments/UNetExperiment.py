...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: The shape is [BATCH_SIZE, 3, PATCH_SIZE, PATCH_SIZE]
            # prediction_softmax[i,j,k,l] is the probability that the (k,l) pixel
            # in the i^th image of the batch is of class j.
    ...
    def run_test(self):
        ...
        inference_agent = UNetInferenceAgent(
            model=self.model, device=self.device, patch_size=self.patch_size
        )
