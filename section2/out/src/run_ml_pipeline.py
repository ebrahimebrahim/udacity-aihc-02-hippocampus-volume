...
if __name__ == "__main__":
    ...
    c.test_results_dir = "../../test_results"
    ...
    split_index1 = len(keys_array)//10
    split_index2 = 2*split_index1
    split = {
        'test' : keys_array[:split_index1],
        'val' : keys_array[split_index1:split_index2],
        'train' : keys_array[split_index2:]
    }
